...
# About
This project is a chat web application built for SOEN 341 during the Winter 2025 term.
...
1. Text Channels for Group Communication: Users can join a set of channels (e.g., "General," "Project Help," "Social"), and all messages sent in a channel are visible to all users in that channel.
...
4. More features to come... Stay tuned!
